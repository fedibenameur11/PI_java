...
public class AfficherLivraison1Controller implements Initializable {
  ...
  @FXML
    ...
    @FXML 
        void switchButton1(ActionEvent event) throws IOException {
         FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AjouterLivraison1.fxml"));
    ...
    @FXML 
       ...
       FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ModifierLivraison1.fxml"));
        Parent parent = fxmlLoader.load();
        Stage stage = new Stage();
        stage.initModality(Modality.APPLICATION_MODAL);
        stage.initStyle(StageStyle.DECORATED);
  ...
  FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AfficherCommandes2.fxml"));
        Parent parent = fxmlLoader.load();
        Stage stage = new Stage();
        stage.initModality(Modality.APPLICATION_MODAL);
        stage.initStyle(StageStyle.DECORATED);
