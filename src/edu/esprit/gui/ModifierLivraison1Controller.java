...
public class ModifierLivraison1Controller implements Initializable {
    ...
    private LivraisonService salleService;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        salleService = new LivraisonService();
    }    
    ...
    public void modifierSalle() {
        try {
            ...
            Livraison salles = new Livraison();
