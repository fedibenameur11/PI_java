...
import edu.esprit.gui.AfficherSalle1Controller;
...
public class ExportPdf {
    ...
    if (selectedSalle != null) {
      ...
      try {   
          ...
          PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream("C:\\Users\\wassim\\OneDrive\\Documents\\Salle.pdf"));
          doc.open();
           ...
           Desktop.getDesktop().open(new File ("C:\\Users\\wassim\\OneDrive\\Documents\\Salle.pdf"));
